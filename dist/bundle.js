...
exports.render_and_return = render_and_return;
exports.fetch_wrapper = fetch_wrapper;
function render_and_return(template) {
    return fetch_wrapper(template).then(function (body) {
        document.body.innerHTML = body;
    });
}

function fetch_wrapper(template) {
...
var _jwlib = __webpack_require__(0);

var jwlib = _interopRequireWildcard(_jwlib);
